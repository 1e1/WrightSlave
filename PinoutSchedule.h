#ifndef CoreSlave_PinoutSchedule_h
#define CoreSlave_PinoutSchedule_h
...
class PinoutSchedule : public PinoutDigital {
...
void PinoutSchedule::setActive(const boolean v)
{
...
__attribute__((always_inline)) inline
const boolean PinoutSchedule::hasPin(const uint8_t iPin)
{
